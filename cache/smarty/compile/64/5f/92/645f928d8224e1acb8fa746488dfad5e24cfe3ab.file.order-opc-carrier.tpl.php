<?php /* Smarty version Smarty-3.1.14, created on 2014-11-24 23:11:07
         compiled from "D:\wamp\www\prestashop\themes\default\mobile\order-opc-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:217085473acfba587a4-21755225%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '645f928d8224e1acb8fa746488dfad5e24cfe3ab' => 
    array (
      0 => 'D:\\wamp\\www\\prestashop\\themes\\default\\mobile\\order-opc-carrier.tpl',
      1 => 1390208062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '217085473acfba587a4-21755225',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5473acfc04a567_80855713',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5473acfc04a567_80855713')) {function content_5473acfc04a567_80855713($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
";
	var orderUrl = '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink("order",true), ENT_QUOTES, 'UTF-8', true);?>
';
...
<?php if (!$_smarty_tpl->tpl_vars['product']->last){?>, <?php }else{ ?>)<?php }?><?php }?><?php } ?>
	...
	<fieldset data-role="fieldcontain">
		<input type="checkbox" name="same" id="recyclable" value="1" class="delivery_option_radio" <?php if ($_smarty_tpl->tpl_vars['recyclable']->value==1){?>checked="checked"<?php }?> autocomplete="off"/>
...
<?php }?><?php }?>)
	...
	<fieldset data-role="fieldcontain" id="cgv_checkbox">
		<input type="checkbox" value="1" id="cgv" name="cgv" <?php if ($_smarty_tpl->tpl_vars['checkedTOS']->value){?>checked="checked"<?php }?> autocomplete="off"/>
