<?php /* Smarty version Smarty-3.1.14, created on 2014-11-24 23:10:57
         compiled from "D:\wamp\www\prestashop\themes\default\contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18185473acf1e0b849-18041333%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '505857a7857895c6cfe933d6ab54817aa556b211' => 
    array (
      0 => 'D:\\wamp\\www\\prestashop\\themes\\default\\contact-form.tpl',
      1 => 1390208062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18185473acf1e0b849-18041333',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5473acf2368ed4_97658799',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5473acf2368ed4_97658799')) {function content_5473acf2368ed4_97658799($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" <?php if (intval($_smarty_tpl->tpl_vars['order']->value['selected'])){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['order']->value['label'], 'htmlall', 'UTF-8');?>
				...
				<?php }elseif(!isset($_smarty_tpl->tpl_vars['customerThread']->value['id_order'])&&empty($_smarty_tpl->tpl_vars['isLogged']->value)){?>
					<input type="text" name="id_order" id="id_order" value="<?php if (isset($_smarty_tpl->tpl_vars['customerThread']->value['id_order'])&&intval($_smarty_tpl->tpl_vars['customerThread']->value['id_order'])>0){?><?php echo intval($_smarty_tpl->tpl_vars['customerThread']->value['id_order']);?>
