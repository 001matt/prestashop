<?php /* Smarty version Smarty-3.1.14, created on 2014-11-24 23:11:19
         compiled from "D:\wamp\www\prestashop\themes\default\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:214925473ad07e0c868-35800059%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b40b30a299c4ebcb478f81f7d2596729927a493' => 
    array (
      0 => 'D:\\wamp\\www\\prestashop\\themes\\default\\order-address-multishipping.tpl',
      1 => 1390208062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '214925473ad07e0c868-35800059',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5473ad0853acf3_39543097',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5473ad0853acf3_39543097')) {function content_5473ad0853acf3_39543097($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'D:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\function.counter.php';
...
<?php }?><?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp3.$_tmp4), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
...
" />
		<?php if ($_smarty_tpl->tpl_vars['back']->value){?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0&amp;back=".((string)$_smarty_tpl->tpl_vars['back']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
		...
		<?php }else{ ?>
			<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"step=0"), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
" class="button">&laquo; <?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</a>
		<?php }?>
