...
class HomeFeatured2 extends Module
{
	...
	function __construct()
	{
		...
		$this->displayName = $this->l('Featured products on the homepage.2');
		$this->description = $this->l('Displays featured products in the middle of your homepage.');
	}

	function install()
	{
		$this->_clearCache('homefeatured2.tpl');
	...
	{
		$this->context->controller->addCSS(($this->_path).'homefeatured2.css', 'all');
	}

	public function hookDisplayHome($params)
	{
		if (!$this->isCached('homefeatured2.tpl', $this->getCacheId('homefeatured')))
		{
		...
		return $this->display(__FILE__, 'homefeatured2.tpl', $this->getCacheId('homefeatured'));
	}
