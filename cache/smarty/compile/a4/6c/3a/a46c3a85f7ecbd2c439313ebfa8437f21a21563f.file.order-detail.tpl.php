<?php /* Smarty version Smarty-3.1.14, created on 2014-11-24 23:11:06
         compiled from "D:\wamp\www\prestashop\themes\default\mobile\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:26495473acfa20b228-58759081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a46c3a85f7ecbd2c439313ebfa8437f21a21563f' => 
    array (
      0 => 'D:\\wamp\\www\\prestashop\\themes\\default\\mobile\\order-detail.tpl',
      1 => 1390208062,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26495473acfa20b228-58759081',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5473acfaec13a4_48663634',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5473acfaec13a4_48663634')) {function content_5473acfaec13a4_48663634($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'D:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include 'D:\\wamp\\www\\prestashop\\tools\\smarty\\plugins\\modifier.replace.php';
?>
...
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink($_tmp1,true,null,"submitReorder&id_order=".$_tmp2), ENT_QUOTES, 'UTF-8', true);?>
...
icon/pdf.gif" alt="" class="icon" />
	<?php if ($_smarty_tpl->tpl_vars['is_guest']->value){?>
		<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-invoice',true,null,"id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&amp;secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value)."->secure_key"), ENT_QUOTES, 'UTF-8', true);?>
" ><?php echo smartyTranslate(array('s'=>'Download your invoice as a PDF file.'),$_smarty_tpl);?>
</a>
	<?php }else{ ?>
		<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-invoice',true,null,"id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)), ENT_QUOTES, 'UTF-8', true);?>
" ><?php echo smartyTranslate(array('s'=>'Download your invoice as a PDF file.'),$_smarty_tpl);?>
</a>
	<?php }?>
</p>
